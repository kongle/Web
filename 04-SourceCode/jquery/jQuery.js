...
(function( window, undefined ) {
    ...
    // Give the init function the jQuery prototype for later instantiation
        ...
        jQuery.extend({
            ...
            isFunction: function( obj ) {   // ie8 函数 会返回 object
            ...
            isPlainObject: function( obj ) {  // 判断普通对象
                // Not plain objects:
            ...
            parseXML: function( data ) {
                ...
                // Support: IE9   ie8 用activexobject 兼容
                try {
                    tmp = new DOMParser();
     ...
     *
     *	stopOnFalse:	interrupt callings when a callback returns false   31
     *
     */
